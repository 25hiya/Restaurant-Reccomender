...
def setup_graph(graph: recommender_data.Graph,
...
def visualize_graph(graph: recommender_data.Graph,
                    layout: str = 'spring_layout',
                    max_vertices: int = 5000,
...
def visualize_weighted_graph(graph: recommender_data.WeightedGraph,
                             layout: str = 'spring_layout',
                             max_vertices: int = 5000,
                             output_file: str = '') -> None:
